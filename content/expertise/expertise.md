...
I designed a confidence interval framework with a traffic lights system around the Gini Coefficient taking into consideration type 1 and 2 errors using Bootstrapping that could assist business decisions on model selection. The findings and method were added in the Rabobank credit monitoring python library and procedures.

- **What I would like to additionally work on in the future**: 
Obligor (and joint-obligor) definition and construction. Machine learning challenger model in the MFA phase.
